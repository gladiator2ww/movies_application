...
ActorFilmographyModel _$ActorFilmographyModelFromJson(
    Map<String, dynamic> json) {
  return _ActorMoviesModel.fromJson(json);
}

/// @nodoc
class _$ActorFilmographyModelTearOff {
  const _$ActorFilmographyModelTearOff();
  ...
  ActorFilmographyModel fromJson(Map<String, Object?> json) {
    return ActorFilmographyModel.fromJson(json);
  }
}

/// @nodoc
const $ActorFilmographyModel = _$ActorFilmographyModelTearOff();

/// @nodoc
mixin _$ActorFilmographyModel {
  ...
  @JsonKey(ignore: true)
  $ActorFilmographyModelCopyWith<ActorFilmographyModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ActorFilmographyModelCopyWith<$Res> {
  factory $ActorFilmographyModelCopyWith(ActorFilmographyModel value,
          $Res Function(ActorFilmographyModel) then) =
      _$ActorFilmographyModelCopyWithImpl<$Res>;
  $Res call({String id, String title, String image, String year});
}

/// @nodoc
class _$ActorFilmographyModelCopyWithImpl<$Res>
    implements $ActorFilmographyModelCopyWith<$Res> {
  _$ActorFilmographyModelCopyWithImpl(this._value, this._then);

  final ActorFilmographyModel _value;
  // ignore: unused_field
  final $Res Function(ActorFilmographyModel) _then;
...
class __$ActorMoviesModelCopyWithImpl<$Res>
    extends _$ActorFilmographyModelCopyWithImpl<$Res>
...
class _$_ActorMoviesModel implements _ActorMoviesModel {
  ...
  @override
  String toString() {
    return 'ActorFilmographyModel(id: $id, title: $title, image: $image, year: $year)';
  }
...
abstract class _ActorMoviesModel implements ActorFilmographyModel {
